            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
                ...
                <GlassCard className="w-full max-w-[540px] relative z-10 !p-0 border-accent-primary/20 shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden">
                    ...
                    <div className="px-5 md:px-8 pt-6 md:pt-8 pb-4 md:pb-6 border-b border-white/5">
                        ...
                        <h2 className="text-xl md:text-2xl font-display font-bold text-text-primary">Custom Study</h2>
                    </div>
                            ...
                            <section>
                                ...
                                <div className="md:hidden">
                                    <div className="relative">
                                        ...
                                        >
                                            {!sourceId && <option value="">Select a source...</option>}
                                            <optgroup label="📚 Texts" className="bg-bg-primary text-text-secondary font-bold">
                                                {texts.map(text => (
                                            ...
                                            <optgroup label="📜 My Lists" className="bg-bg-primary text-text-secondary font-bold">
                                                {lists.map(list => (
